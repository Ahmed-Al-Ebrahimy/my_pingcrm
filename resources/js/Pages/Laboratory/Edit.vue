<template>
    <app-layout>
        <div class="py-6 px-1 flex flex-col lg:flex-row">
            <div class="px-2 sm:px-4 md:px-6   flex w-full sm:w-3/4 md:w-2/3  lg:w-2/4 sm:mr-0 mr-2 mb-3 sm:mb-0">
                <div class="bg-banafsagy-600 overflow-hidden rounded-md">
                <div class="bg-banafsagy-600 overflow-hidden rounded-md border-2 border-red-500 ">
                    ...
                    <div v-for="(visit, index) in patient.visits" :key="index" class="mb-2 border-2 border-gray-300 rounded-md">
                        <div class="normal-case flex justify-center  bg-indigo-800 rounded-md rounded-b-none  p-0  shadow-lg text-gray-100">
                            <span class="p-1">Test of Vist {{patient.visits.length - index}} on {{moment(visit.updated_at).format('YYYY-MM-DD')}}</span>
                        </div>
                   ...
                   <!-- here buttons -->
                    ...
                    <div v-else>
 <span> todays visit not found</span>
                    </div>
            ...
            <div class="px-2 sm:px-4 md:px-6  flex w-full  sm:w-1/4 md:w-1/3 lg:w-2/4 mr-2">

                <div class="bg-banafsagy-600 overflow-hidden rounded-md border-2 border-red-500 ">
                    <div class="p-2 shadow-lg  rounded-md  overflow-y-auto  max-h-96">
