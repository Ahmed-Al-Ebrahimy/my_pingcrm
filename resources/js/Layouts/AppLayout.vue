                        ...
                        <div class="ml-3 relative">
                            <jet-dropdown align="right" width="48">
                                <template #trigger>
                                    ...
                                    <button v-else class="flex items-center text-sm font-medium text-gray-100 hover:text-gray-400 hover:border-gray-300 focus:outline-none focus:text-gray-200 focus:border-gray-300 transition duration-150 ease-in-out">
